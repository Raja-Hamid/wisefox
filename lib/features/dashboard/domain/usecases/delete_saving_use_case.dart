...
class DeleteSavingUseCase implements UseCase<String, SavingEntity> {
  final DashboardRepository repository;

  DeleteSavingUseCase({required this.repository});

  @override
  Future<Either<Failure, String>> call(SavingEntity params) {
    return repository.deleteSaving(entity: params);
  }
}
